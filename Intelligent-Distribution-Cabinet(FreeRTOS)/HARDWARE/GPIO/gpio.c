...
void GPIO_INIT(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB | RCC_APB2Periph_AFIO | RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOC,ENABLE);	//打开GPIO使能时钟，先开复用功能
	...
	GPIO_ResetBits(GPIOC,GPIO_Pin_13); 	//关闭灯  
}
