...
//	if (Qa_REG &0x80000000) 
//		Qa_REG = 0xFFFFFFFF-Qa_REG;
//	if (Qb_REG &0x80000000) 
//		Qb_REG = 0xFFFFFFFF-Qb_REG;
//	if (Qc_REG &0x80000000) 
//		Qc_REG = 0xFFFFFFFF-Qc_REG;
//	if (Qt_REG &0x80000000) 
//		Qt_REG = 0xFFFFFFFF-Qt_REG;
//	rn.Qa = Qa_REG*Kp;  
//	rn.Qb = Qb_REG*Kp;  
//	rn.Qc = Qc_REG*Kp; 
//	rn.Qt = Qt_REG*Kp; 
